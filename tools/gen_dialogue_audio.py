...
GOOGLE_VOICES = [
    {"name": "ja-JP-Chirp3-HD-Zephyr", "ssmlGender": "FEMALE"},
    {"name": "ja-JP-Chirp3-HD-Fenrir", "ssmlGender": "MALE"},
]
...
def main():
    ...
    level_filter = None
    lesson_filter = None
    usage = ("Cách dùng: python tools/gen_dialogue_audio.py [n4|n5] [lessonN]\n"
