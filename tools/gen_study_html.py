...
@media print { #cred-btn, #cred-pop { display:none !important; } }
"""
...
<!-- Credits button -->
<button id="cred-btn" title="Nguồn dữ liệu & License"
  style="position:fixed;bottom:14px;right:14px;width:28px;height:28px;border-radius:50%;
         background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.13);
         color:rgba(255,255,255,.35);font-size:.75rem;cursor:pointer;z-index:9990;
         padding:0;line-height:28px;text-align:center;font-family:system-ui;">?</button>

<div id="cred-pop"
  style="display:none;position:fixed;bottom:50px;right:14px;width:272px;
         background:#12141f;border:1px solid rgba(255,255,255,.1);border-radius:12px;
         padding:14px 16px;z-index:9989;box-shadow:0 8px 32px rgba(0,0,0,.55);
         font-family:system-ui,sans-serif;">
  <div style="font-size:.65rem;color:rgba(255,255,255,.3);letter-spacing:.7px;
              text-transform:uppercase;font-weight:700;margin-bottom:10px">Nguồn dữ liệu</div>

  <div style="margin-bottom:9px;padding-bottom:9px;border-bottom:1px solid rgba(255,255,255,.06)">
    <b style="font-size:.82rem;color:#e2e8f0">KanjiVG</b>
    <span style="display:inline-block;font-size:.6rem;padding:1px 5px;border-radius:3px;
                 background:rgba(99,102,241,.18);color:#818cf8;font-weight:700;margin-left:4px;vertical-align:middle">CC BY-SA 3.0</span><br>
    <span style="font-size:.72rem;color:rgba(255,255,255,.38)">Stroke order SVG · © Ulrich Apel</span><br>
    <a href="https://github.com/KanjiVG/kanjivg" target="_blank" rel="noopener"
       style="font-size:.7rem;color:#818cf8;text-decoration:none">github.com/KanjiVG/kanjivg</a>
  </div>

  <div>
    <b style="font-size:.82rem;color:#e2e8f0">the-kanji-map</b>
    <span style="display:inline-block;font-size:.6rem;padding:1px 5px;border-radius:3px;
                 background:rgba(99,102,241,.18);color:#818cf8;font-weight:700;margin-left:4px;vertical-align:middle">CC BY-SA 3.0</span><br>
    <span style="font-size:.72rem;color:rgba(255,255,255,.38)">Radical · component · mnemonic data</span><br>
    <a href="https://github.com/thekanjimap/the-kanji-map" target="_blank" rel="noopener"
       style="font-size:.7rem;color:#818cf8;text-decoration:none">github.com/thekanjimap/the-kanji-map</a>
  </div>
</div>
...
(function(){{
  ...
  var pop = document.getElementById('cred-pop');
